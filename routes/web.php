...
// Payment
    Route::get('payment', [PayCardController::class, 'payment'])->name('payment');
    Route::get('cancel', [PayCardController::class, 'cancel'])->name('payment.cancel');
    Route::get('payment/success', [PayCardController::class, 'success'])->name('payment.success');
