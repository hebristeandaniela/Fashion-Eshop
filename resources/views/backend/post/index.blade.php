...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Lista de postări</h6>
    ...
    @else
      <h6 class="text-center">Nu s-au găsit postări!!! Vă rugăm să creați o postare</h6>
  @endif
      </div>
    </div>
</div>
...
@push('scripts')
  ...
  <script>
    ...
    $('.dltBtn').click(function(e){
      ...
      swal({
      title: "Esti sigur?",
    text: "Odată șterse, nu veți mai putea rec upera aceste date!",
    icon: "warning",
            buttons: true,
      dangerMode: true,
      })
