...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Lista de categorii</h6>
      <a href="{{route('category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Adaugă categorie</a>
    </div>
    <div class="card-body">
      ...
      <table class="table table-bordered" id="banner-dataTable" width="100%" cellspacing="0">
        ...
        @foreach($categories as $category)
          ...
          <tr>
            ...
            <td>{{$category->slug}}</td>
            <td>{{(($category->is_parent == 1) ? 'Da' : 'Nu')}}</td>
            <td>
    ...
    @else
      <h6 class="text-center">Nu s-au găsit categorii!!! Vă rugăm să creați o categorie</h6>
  @endif
      </div>
    </div>
</div>
...
@push('scripts')
  ...
  <script>
    ...
    var form=$(this).closest('form');
      ...
      swal({
        title: "Esti sigur?",
      text: "Odată șterse, nu veți mai putea recupera aceste date!",
      icon: "warning",
      buttons: true,
      dangerMode: true,
      })
      ...
      if (willDelete) {
        ...
        swal("Datele dvs. sunt în siguranță!");
      }
      });
    })
    })
