...
<div class="card">
    <h5 class="card-header">Adaugă categorie</h5>
    <div class="card-body">
      <form method="post" action="{{route('category.store')}}">
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_parent' id='is_parent' value='1' checked> Da                       
        </div>
        {{-- {{$parent_cats}} --}}
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">--Selectați orice categorie--</label>
