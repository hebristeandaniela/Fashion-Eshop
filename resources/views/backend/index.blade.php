      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Comandă</div>
                <div class="row no-gutters align-items-center">
                  <div class="col-auto">
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Postare</div>
      ...
      <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Prezentare generală a veniturilor</h6>
...
@push('scripts')
  ...
  <script type="text/javascript">
    ...
    function drawChart()
    {
      ...
      var options = {
        title : 'Ultimele 7 zile utilizator înregistrat'
      };
          ...
          var myLineChart = new Chart(ctx, {
            ...
            scales: {
              ...
              ticks: {
                ...
                return number_format(value) + ' RON ';
                }
              },
              gridLines: {
            ...
            tooltips: {
              ...
              label: function(tooltipItem, chart) {
                ...
                return datasetLabel + number_format(tooltipItem.yLabel)+ ' : RON ' ;
              }
              }
            }
            }
