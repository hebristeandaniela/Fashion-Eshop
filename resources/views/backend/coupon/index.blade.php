...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Lista de cupoane</h6>
      <a href="{{route('coupon.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Adaugă cupon</a>
    </div>
    <div class="card-body">
      ...
      <table class="table table-bordered" id="banner-dataTable" width="100%" cellspacing="0">
        ...
        @foreach($coupons as $coupon)   
          <tr>
            ...
            <td>
              @if($coupon->type == 'fixed')
                {{number_format($coupon->value, 2)}} RON
              @else
                {{$coupon->value}}%
              @endif</td>
            <td>
    ...
    @else
      <h6 class="text-center">Nu s-au găsit cupoane!!! Vă rugăm să creați un cupon</h6>
  @endif
      </div>
    </div>
</div>
