...
@section('title', 'E-SHOP || Pagina de comentarii')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Lista de comentarii</h6>
    </div>
    <div class="card-body">
    ...
    @else
          <h6 class="text-center">Nu s-au găsit comentarii!!!</h6>
        @endif
      </div>
    </div>
</div>
