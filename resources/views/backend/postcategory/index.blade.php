...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Lista categoriilor de postare</h6>
      <a href="{{route('post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Adaugă o categorie de postare</a>
    </div>
    <div class="card-body">
    ...
    @else
      <h6 class="text-center">Nu s-au găsit categorii a postărilor!!! Vă rugăm să creați o categorie de postare</h6>
  @endif
      </div>
    </div>
</div>
