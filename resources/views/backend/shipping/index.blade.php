...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Lista de transporturi</h6>
      <a href="{{route('shipping.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Adaugă transport</a>
    </div>
    <div class="card-body">
    ...
    @else
      <h6 class="text-center">Nu s-au găsit transporturi!!! Vă rugăm să creați transportul</h6>
  @endif
      </div>
    </div>
</div>
