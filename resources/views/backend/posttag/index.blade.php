...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Lista etichetelor postării</h6>
      <a href="{{route('post-tag.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Adaugă eticheta postării</a>
    </div>
    <div class="card-body">
    ...
    @else
          <h6 class="text-center">Nu s-au găsit etichetele postării!!! Vă rugăm să creați o etichetă a postării</h6>
        @endif
      </div>
    </div>
</div>
