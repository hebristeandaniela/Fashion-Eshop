...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="short_des" class="col-form-label">Descriere scurtă <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Descriere <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="address" class="col-form-label">Adresa <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="phone" class="col-form-label">Număr telefon <span class="text-danger">*</span></label>
...
@push('scripts')
  ...
  $(document).ready(function() {
    ...
    placeholder: "Scrieți descrierea detaliată.....",
    tabsize: 2,
    height: 150
    });
  });
