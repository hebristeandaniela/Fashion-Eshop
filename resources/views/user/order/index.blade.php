...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Liste de comenzi</h6>
    </div>
    <div class="card-body">
    ...
    @else
      <h6 class="text-center">Nu s-au găsit comenzi!!! Vă rugăm să comandați câteva produse</h6>
  @endif
      </div>
    </div>
</div>
