...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Lista de recenzii</h6>
    </div>
    <div class="card-body">
      ...
      <tr>
        <th>S.N.</th>
        <th>Recenzie de la</th>
        <th>Titlul produsului</th>
        <th>Recenzie</th>
        <th>Rate</th>
        <th>Data</th>
        <th>Status</th>
    ...
    @else
          <h6 class="text-center">Nu au fost găsite recenzii!!!</h6>
        @endif
      </div>
    </div>
</div>
